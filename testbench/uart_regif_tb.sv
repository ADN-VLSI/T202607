...
module uart_regif_tb;
    ...
    uart_regif #(
        ...
        .clk_i           (clk),
        .rst_ni          (rst_n),
        .mem_valid_i     (mem_valid_sig),
        .mem_write_i     (mem_write_sig),
        .mem_addr_i      (mem_addr_sig),
        .mem_wdata_i     (mem_wdata_sig),
        .mem_wstrb_i     (mem_wstrb_sig),
        .mem_ready_o     (mem_ready_sig),
        .mem_rdata_o     (mem_rdata_sig),
        .mem_error_o     (mem_error_sig),
